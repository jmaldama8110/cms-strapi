...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    metaData: Attribute.Component<'seo.meta-info'>;
    menu: Attribute.Component<'element.menu'>;
    backgroundSlides: Attribute.Component<'element.slider'>;
    introSection: Attribute.Component<'block.intro'>;
    teamCompanySection: Attribute.Component<'block.about'>;
    caseStudiesSection: Attribute.Component<'block.case-studies'>;
    servicesSection: Attribute.Component<'block.services'>;
    blogSection: Attribute.Component<'block.blog'>;
    contactSection: Attribute.Component<'block.contac'>;
    footerSection: Attribute.Component<'block.footer'>;
